<?php
  ...
  class validation{
     ...
     //エラーやサクセスメッセージ関係
      ...
      //入力チェック
    protected function validRequired($string,$key){
      if(empty($string)){
    ...
    //email確認
    protected function validEmail($string, $key){
    ...
    //最大文字数チェック
    protected function validMaxLen($string, $key, $max = 255){
    ...
    //最大文字数チェック(email専用)
    protected function validMaxLenEmail($string, $key, $max = 31){
